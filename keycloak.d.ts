...
declare namespace KeycloakConnect {
    ...
    interface Keycloak {
        ...
        getGrantManager(request: express.Request)

        getConfig(request: express.Request): KeycloakConfig
        ...
        loginUrl(request: express.Request, uuid: string, redirectUrl: string): string

        logoutUrl(request: express.Request, redirectUrl: string, idTokenHint?: string): string

        accountUrl(): string

        getAccount(request: express.Request, token)
        ...
        getRealmName(request: express.Request);

        getRealmNameFromToken(token)

        getRealmNameFromRequest(request: express.Request)
    }
